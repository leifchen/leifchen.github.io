$(document).ready(function() {
  var r = {
    ...
    encode: function(t) {
      var e, o, n, a, c, h, d, i = "",
        C = 0;
      for (t = r._utf8_encode(t); C < t.length;) a = (e = t.charCodeAt(C++)) >> 2, c = (3 & e) << 4 | (o = t.charCodeAt(C++)) >> 4, h = (15 & o) << 2 | (n = t.charCodeAt(C++)) >> 6, d = 63 & n, isNaN(o) ? h = d = 64 : isNaN(n) && (d = 64), i = i + this._keyStr.charAt(a) + this._keyStr.charAt(c) + this._keyStr.charAt(h) + this._keyStr.charAt(d);
      return i
    },
    decode: function(t) {
      var e, o, n, a, c, h, d = "",
        i = 0;
      for (t = t.replace(/[^A-Za-z0-9+/=]/g, ""); i < t.length;) e = this._keyStr.indexOf(t.charAt(i++)) << 2 | (a = this._keyStr.indexOf(t.charAt(i++))) >> 4, o = (15 & a) << 4 | (c = this._keyStr.indexOf(t.charAt(i++))) >> 2, n = (3 & c) << 6 | (h = this._keyStr.indexOf(t.charAt(i++))), d += String.fromCharCode(e), 64 != c && (d += String.fromCharCode(o)), 64 != h && (d += String.fromCharCode(n));
