! function(t) {
  ...
  e.VERSION = "3.3.5", e.RESET = "affix affix-top affix-bottom", e.DEFAULTS = {
    ...
    if (null != i && "top" === this.affixed) return f < i && "top";
    if ("bottom" === this.affixed) return null != i ? !(f + this.unpin <= n.top) && "bottom" : !(f + s <= t - o) && "bottom";
    var a = null == this.affixed,
      h = a ? f : n.top;
    return null != i && f <= i ? "top" : null != o && h + (a ? s : e) >= t - o && "bottom"
