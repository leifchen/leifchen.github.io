! function(e, t) {
  ...
  var x = function(e) {
    ...
    function oe(e, t, r, i) {
      var o, a, l, c, f, h, m, y, T, C;
      if ((t ? t.ownerDocument || t : w) !== d && p(t), t = t || d, r = r || [], c = t.nodeType, "string" != typeof e || !e || 1 !== c && 9 !== c && 11 !== c) return r;
      if (!i && g) {
        if (11 !== c && (o = Z.exec(e)))
          if (l = o[1]) {
            if (9 === c) {
            ...
            if ((l = o[3]) && n.getElementsByClassName) return H.apply(r, t.getElementsByClassName(l)), r
          } if (n.qsa && (!v || !v.test(e))) {
          if (y = m = b, T = t, C = 1 !== c && e, 1 === c && "object" !== t.nodeName.toLowerCase()) {
          ...
          if (C) try {
            return H.apply(r, T.querySelectorAll(C)), r
          } catch (e) {} finally {
    ...
    for (t in n = oe.support = {}, o = oe.isXML = function(e) {
        ...
        return s !== d && 9 === s.nodeType && s.documentElement ? (d = s, h = s.documentElement, (i = s.defaultView) && i !== i.top && (i.addEventListener ? i.addEventListener("unload", ie, !1) : i.attachEvent && i.attachEvent("onunload", ie)), g = !o(s), n.attributes = ue(function(e) {
          return e.className = "i", !e.getAttribute("className")
        }), n.getElementsByTagName = ue(function(e) {
          return e.appendChild(s.createComment("")), !e.getElementsByTagName("*").length
        }), n.getElementsByClassName = K.test(s.getElementsByClassName), n.getById = ue(function(e) {
          return h.appendChild(e).id = b, !s.getElementsByName || !s.getElementsByName(b).length
        ...
        }, m = [], v = [], (n.qsa = K.test(s.querySelectorAll)) && (ue(function(e) {
        ...
        if ((e.ownerDocument || e) !== d && p(e), t = t.replace(U, "='$1']"), !(!n.matchesSelector || !g || m && m.test(t) || v && v.test(t))) try {
          var r = y.call(e, t);
            ...
            return 1 === r && 0 === i ? function(e) {
              ...
              if (v) {
                ...
                if (h = [s ? v.firstChild : v.lastChild], s && y) {
                  for (d = (l = (c = v[b] || (v[b] = {}))[e] || [])[0] === T && l[1], p = l[0] === T && l[2], f = d && v.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();)
                  ...
                  for (;
                    (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++p || (y && ((f[b] || (f[b] = {}))[e] = [T, p]), f !== t)););
        ...
        pseudos: {
          ...
          lang: ae(function(e) {
            return Y.test(e || "") || oe.error("unsupported lang: " + e), e = e.replace(ne, re).toLowerCase(),
              function(t) {
                var n;
                do {
    ...
    function be(e, t, n, r, i, o) {
      return r && !r[b] && (r = be(r)), i && !i[b] && (i = be(i, o)), ae(function(o, s, a, u) {
        var l, c, f, p = [],
          d = [],
          h = s.length,
          g = o || function(e, t, n) {
        ...
        } else m = xe(m === s ? m.splice(h, m.length) : m), i ? i(null, s, m, u) : H.apply(s, m)
      })
    }
    ...
    function we(e) {
      for (var t, n, i, o = e.length, s = r.relative[e[0].type], a = s || r.relative[" "], u = s ? 1 : 0, c = me(function(e) {
        ...
        if (n = r.relative[e[u].type]) p = [me(ye(p), n)];
        else {
          if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
            for (i = ++u; o > i && !r.relative[e[i].type]; i++);
            return be(u > 1 && ye(p), u > 1 && ve(e.slice(0, u - 1).concat({
              value: " " === e[u - 2].type ? "*" : ""
            })).replace(_, "$1"), n, i > u && we(e.slice(u, i)), o > i && we(e = e.slice(i)), o > i && ve(e))
          }
          p.push(n)
        } return ye(p)
    }
      ...
      var n = t.length > 0,
        ...
        o = function(o, s, a, u, c) {
          var f, p, h, g = 0,
            ...
            C = b.length;
          for (c && (l = s !== d && s); v !== C && null != (f = b[v]); v++) {
            if (i && f) {
              for (p = 0; h = e[p++];)
                if (h(f, s, a)) {
                  u.push(f);
          ...
          if (g += v, n && v !== g) {
            for (p = 0; h = t[p++];) h(m, y, s, a);
            if (o) {
              if (g > 0)
                for (; v--;) m[v] || y[v] || (y[v] = L.call(u));
              y = xe(y)
            }
            H.apply(u, y), c && !o && y.length > 0 && g + t.length > 1 && oe.uniqueSort(u)
          }
          return c && (T = w, l = x), m
        };
      return n ? ae(o) : o
      ...
      if (i = i || [], 1 === h.length) {
        ...
        for (u = G.needsContext.test(e) ? 0 : l.length; u-- && (c = l[u], !r.relative[f = c.type]);)
          if ((p = r.find[f]) && (o = p(c.matches[0].replace(ne, re), ee.test(l[0].type) && he(t.parentNode) || t))) {
            if (l.splice(u, 1), !(e = o.length && ve(l))) return H.apply(i, o), i;
            break
          }
      }
      return (d || a(e, h))(o, t, !g, i, ee.test(e) && he(t.parentNode) || t), i
  ...
  d.Callbacks = function(e) {
    ...
    ready: function(e) {
      (!0 === e ? --d.readyWait : d.isReady) || (d.isReady = !0, !0 !== e && --d.readyWait > 0 || (j.resolveWith(f, [d]), d.fn.triggerHandler && (d(f).triggerHandler("ready"), d(f).off("ready"))))
    }
  }), d.ready.promise = function(t) {
    return j || (j = d.Deferred(), "complete" === f.readyState ? setTimeout(d.ready) : (f.addEventListener("DOMContentLoaded", q, !1), e.addEventListener("load", q, !1))), j.promise(t)
  }, d.ready.promise();
  ...
  d.event = {
    ...
    add: function(e, t, n, r, i) {
      var o, s, a, u, l, c, f, p, h, g, v, m = F.get(e);
      if (m)
        for (n.handler && (n = (o = n).handler, i = o.selector), n.guid || (n.guid = d.guid++), (u = m.events) || (u = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
          ...
          }), l = (t = (t || "").match(A) || [""]).length; l--;) h = v = (a = Y.exec(t[l]) || [])[1], g = (a[2] || "").split(".").sort(), h && (f = d.event.special[h] || {}, h = (i ? f.delegateType : f.bindType) || h, f = d.event.special[h] || {}, c = d.extend({
          type: h,
          origType: v,
          data: r,
          handler: n,
    ...
    remove: function(e, t, n, r, i) {
      var o, s, a, u, l, c, f, p, h, g, v, m = F.hasData(e) && F.get(e);
      if (m && (u = m.events)) {
        for (l = (t = (t || "").match(A) || [""]).length; l--;)
          if (h = v = (a = Y.exec(t[l]) || [])[1], g = (a[2] || "").split(".").sort(), h) {
        ...
        d.isEmptyObject(u) && (delete m.handle, F.remove(e, "events"))
      }
    },
    trigger: function(t, n, r, i) {
      ...
      if (s = a = r = r || f, 3 !== r.nodeType && 8 !== r.nodeType && !V.test(v + d.event.triggered) && (v.indexOf(".") >= 0 && (v = (m = v.split(".")).shift(), m.sort()), c = v.indexOf(":") < 0 && "on" + v, (t = t[d.expando] ? t : new d.Event(v, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = m.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : d.makeArray(n, [t]), h = d.event.special[v] || {}, i || !h.trigger || !1 !== h.trigger.apply(r, n))) {
        if (!i && !h.noBubble && !d.isWindow(r)) {
          for (u = h.delegateType || v, V.test(u + v) || (s = s.parentNode); s; s = s.parentNode) g.push(s), a = s;
          a === (r.ownerDocument || f) && g.push(a.defaultView || a.parentWindow || e)
        }
        for (o = 0;
          (s = g[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : h.bindType || v, (p = (F.get(s, "events") || {})[t.type] && F.get(s, "handle")) && p.apply(s, n), (p = c && s[c]) && p.apply && d.acceptData(s) && (t.result = p.apply(s, n), !1 === t.result && t.preventDefault());
        return t.type = v, i || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(g.pop(), n) || !d.acceptData(r) || c && d.isFunction(r[v]) && !d.isWindow(r) && ((a = r[c]) && (r[c] = null), d.event.triggered = v, r[v](), d.event.triggered = void 0, a && (r[c] = a)), t.result
      }
    },
    dispatch: function(e) {
      e = d.event.fix(e);
  ...
  se.optgroup = se.option, se.tbody = se.tfoot = se.colgroup = se.caption = se.thead, se.th = se.td, d.extend({
    ...
    domManip: function(e, t) {
      ...
      var n, r, o, s, a, u, l = 0,
        ...
        g = e[0],
        v = d.isFunction(g);
      if (v || f > 1 && "string" == typeof g && !c.checkClone && ne.test(g)) return this.each(function(n) {
        var r = p.eq(n);
  ...
  function me(e) {
    var t = f,
      n = ge[e];
    return n || ("none" !== (n = ve(e, t)) && n || ((t = (he = (he || d("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentDocument).write(), t.close(), n = ve(e, t), he.detach()), ge[e] = n), n
  }
  var ye = /^margin/,
  ...
  function Le(e, t, n, r, i) {
    for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) "margin" === n && (s += d.css(e, n + I[o], !0, i)), r ? ("content" === n && (s -= d.css(e, "padding" + I[o], !0, i)), "margin" !== n && (s -= d.css(e, "border" + I[o] + "Width", !0, i))) : (s += d.css(e, "padding" + I[o], !0, i), "padding" !== n && (s += d.css(e, "border" + I[o] + "Width", !0, i)));
    return s
  }
  ...
  function He(e, t) {
    for (var n, r, i, o = [], s = 0, a = e.length; a > s; s++)(r = e[s]).style && (o[s] = F.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && B(r) && (o[s] = F.access(r, "olddisplay", me(r.nodeName)))) : (i = B(r), "none" === n && i || F.set(r, "olddisplay", i ? n : d.css(r, "display"))));
  ...
  d.extend({
    ...
    css: function(e, t, n, r) {
      var i, o, s, a = d.camelCase(t);
      return t = d.cssProps[a] || (d.cssProps[a] = je(e.style, a)), (s = d.cssHooks[t] || d.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = we(e, t, r)), "normal" === i && t in Se && (i = Se[t]), "" === n || n ? (o = parseFloat(i), !0 === n || d.isNumeric(o) ? o || 0 : i) : i
    }
  ...
  var Fe, Pe, Re = /^(?:toggle|show|hide)$/,
    ...
    $e = [function(e, t, n) {
      ...
      for (r in n.queue || (null == (a = d._queueHooks(e, "fx")).unqueued && (a.unqueued = 0, u = a.empty.fire, a.empty.fire = function() {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], l = d.css(e, "display"), "inline" === ("none" === l ? F.get(e, "olddisplay") || me(e.nodeName) : l) && "none" === d.css(e, "float") && (p.display = "inline-block")), n.overflow && (p.overflow = "hidden", c.always(function() {
    ...
    Ie = {
      "*": [function(e, t) {
        var n = this.createTween(e, t),
          ...
          s = (d.cssNumber[e] || "px" !== o && +r) && Me.exec(d.css(n.elem, e)),
          a = 1,
          u = 20;
        if (s && s[3] !== o) {
          o = o || s[3], i = i || [], s = +r || 1;
  ...
  function ze(e, t, n) {
    for (var r, i = (Ie[t] || []).concat(Ie["*"]), o = 0, s = i.length; s > o; o++)
  ...
  d.Animation = d.extend(Xe, {
      tweener: function(e, t) {
        ...
        for (var n, r = 0, i = e.length; i > r; r++) n = e[r], Ie[n] = Ie[n] || [], Ie[n].unshift(t)
      },
      ...
      var n, r, i, o, s, a, u, l, c = d.ajaxSetup({}, t),
        ...
        w = {
          ...
          getResponseHeader: function(e) {
            ...
            if (2 === x) {
              if (!o)
                for (o = {}; t = tt.exec(i);) o[t[1].toLowerCase()] = t[2];
              t = o[e.toLowerCase()]
            }
  ...
  d.param = function(e, t) {
    ...
    serializeArray: function() {
      return this.map(function() {
        ...
        var e = this.type;
        return this.name && !d(this).is(":disabled") && mt.test(this.nodeName) && !vt.test(e) && (this.checked || !_.test(e))
      }).map(function(e, t) {
        var n = d(this).val();
  ...
  return d.noConflict = function(t) {
    return e.$ === d && (e.$ = jt), t && e.jQuery === d && (e.jQuery = Dt), d
